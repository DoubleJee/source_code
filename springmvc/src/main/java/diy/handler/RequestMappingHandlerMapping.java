...
import diy.annotaion.ComponentScan;
...
public class RequestMappingHandlerMapping {
    ...
    public void initHandlerMapping(Class classInfo, String servletPrefix) {
        try {
            ComponentScan componentScan = (ComponentScan) classInfo.getDeclaredAnnotation(ComponentScan.class);
            if (componentScan == null || StringUtils.isEmpty(componentScan.value())) {
                return;
            }
            Set<Class<?>> classes = getClasses(componentScan.value());
            ...
            for (Class c : classes) {
                ...
                String urlPrefix = servletPrefix;
                ...
                for (Method declaredMethod : declaredMethods) {
                    ...
                    registry.put(url, new HandlerMethod(target, declaredMethod));
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
